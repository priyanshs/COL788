...
if [ ! -f ${CONVERTED_PERSON_MODEL_INT8} ]; then
  ...
  echo '#include "/Users/priyansh/Git-Repos/COL788/Assignment1/STSW-STLKT01_V2.5.0/Projects/SensorTile/Applications/AudioLoop/STM32CubeIDE/STM32L4xx-SensorTile/tensorflow/lite/micro/models/person_detect_model_data.h"' >> \
