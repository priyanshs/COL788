...
CC_DEPS += \
./tensorflow/lite/micro/examples/network_tester/network_tester_test.d 

OBJS += \
./tensorflow/lite/micro/examples/network_tester/network_tester_test.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite/micro/examples/network_tester/%.o tensorflow/lite/micro/examples/network_tester/%.su tensorflow/lite/micro/examples/network_tester/%.cyclo: ../tensorflow/lite/micro/examples/network_tester/%.cc tensorflow/lite/micro/examples/network_tester/subdir.mk
...
clean: clean-tensorflow-2f-lite-2f-micro-2f-examples-2f-network_tester

clean-tensorflow-2f-lite-2f-micro-2f-examples-2f-network_tester:
	-$(RM) ./tensorflow/lite/micro/examples/network_tester/network_tester_test.cyclo ./tensorflow/lite/micro/examples/network_tester/network_tester_test.d ./tensorflow/lite/micro/examples/network_tester/network_tester_test.o ./tensorflow/lite/micro/examples/network_tester/network_tester_test.su

.PHONY: clean-tensorflow-2f-lite-2f-micro-2f-examples-2f-network_tester
