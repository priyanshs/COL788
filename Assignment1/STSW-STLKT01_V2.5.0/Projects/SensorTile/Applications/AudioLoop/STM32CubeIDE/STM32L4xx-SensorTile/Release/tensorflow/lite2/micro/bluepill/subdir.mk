...
CC_SRCS += \
../tensorflow/lite2/micro/bluepill/debug_log.cc 

CC_DEPS += \
./tensorflow/lite2/micro/bluepill/debug_log.d 

OBJS += \
./tensorflow/lite2/micro/bluepill/debug_log.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/micro/bluepill/%.o tensorflow/lite2/micro/bluepill/%.su tensorflow/lite2/micro/bluepill/%.cyclo: ../tensorflow/lite2/micro/bluepill/%.cc tensorflow/lite2/micro/bluepill/subdir.mk
...
clean: clean-tensorflow-2f-lite2-2f-micro-2f-bluepill

clean-tensorflow-2f-lite2-2f-micro-2f-bluepill:
	-$(RM) ./tensorflow/lite2/micro/bluepill/debug_log.cyclo ./tensorflow/lite2/micro/bluepill/debug_log.d ./tensorflow/lite2/micro/bluepill/debug_log.o ./tensorflow/lite2/micro/bluepill/debug_log.su

.PHONY: clean-tensorflow-2f-lite2-2f-micro-2f-bluepill
