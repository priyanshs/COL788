...
CC_SRCS += \
../tensorflow/lite2/micro/arc_emsdp/debug_log.cc 

CC_DEPS += \
./tensorflow/lite2/micro/arc_emsdp/debug_log.d 

OBJS += \
./tensorflow/lite2/micro/arc_emsdp/debug_log.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/micro/arc_emsdp/%.o tensorflow/lite2/micro/arc_emsdp/%.su tensorflow/lite2/micro/arc_emsdp/%.cyclo: ../tensorflow/lite2/micro/arc_emsdp/%.cc tensorflow/lite2/micro/arc_emsdp/subdir.mk
...
clean: clean-tensorflow-2f-lite2-2f-micro-2f-arc_emsdp

clean-tensorflow-2f-lite2-2f-micro-2f-arc_emsdp:
	-$(RM) ./tensorflow/lite2/micro/arc_emsdp/debug_log.cyclo ./tensorflow/lite2/micro/arc_emsdp/debug_log.d ./tensorflow/lite2/micro/arc_emsdp/debug_log.o ./tensorflow/lite2/micro/arc_emsdp/debug_log.su

.PHONY: clean-tensorflow-2f-lite2-2f-micro-2f-arc_emsdp
