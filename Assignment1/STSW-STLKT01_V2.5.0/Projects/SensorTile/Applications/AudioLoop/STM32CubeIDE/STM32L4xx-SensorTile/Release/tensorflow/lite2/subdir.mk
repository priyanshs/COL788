...
CC_SRCS += \
../tensorflow/lite2/array.cc 

CC_DEPS += \
./tensorflow/lite2/array.d 

OBJS += \
./tensorflow/lite2/array.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/%.o tensorflow/lite2/%.su tensorflow/lite2/%.cyclo: ../tensorflow/lite2/%.cc tensorflow/lite2/subdir.mk
...
clean: clean-tensorflow-2f-lite2

clean-tensorflow-2f-lite2:
	-$(RM) ./tensorflow/lite2/array.cyclo ./tensorflow/lite2/array.d ./tensorflow/lite2/array.o ./tensorflow/lite2/array.su

.PHONY: clean-tensorflow-2f-lite2
