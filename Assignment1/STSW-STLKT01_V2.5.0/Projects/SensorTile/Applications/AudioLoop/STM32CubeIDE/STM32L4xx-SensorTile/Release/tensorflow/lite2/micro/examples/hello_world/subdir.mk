...
CC_SRCS += \
../tensorflow/lite2/micro/examples/hello_world/hello_world_test.cc 

CC_DEPS += \
./tensorflow/lite2/micro/examples/hello_world/hello_world_test.d 

OBJS += \
./tensorflow/lite2/micro/examples/hello_world/hello_world_test.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/micro/examples/hello_world/%.o tensorflow/lite2/micro/examples/hello_world/%.su tensorflow/lite2/micro/examples/hello_world/%.cyclo: ../tensorflow/lite2/micro/examples/hello_world/%.cc tensorflow/lite2/micro/examples/hello_world/subdir.mk
...
clean: clean-tensorflow-2f-lite2-2f-micro-2f-examples-2f-hello_world

clean-tensorflow-2f-lite2-2f-micro-2f-examples-2f-hello_world:
	-$(RM) ./tensorflow/lite2/micro/examples/hello_world/hello_world_test.cyclo ./tensorflow/lite2/micro/examples/hello_world/hello_world_test.d ./tensorflow/lite2/micro/examples/hello_world/hello_world_test.o ./tensorflow/lite2/micro/examples/hello_world/hello_world_test.su

.PHONY: clean-tensorflow-2f-lite2-2f-micro-2f-examples-2f-hello_world
