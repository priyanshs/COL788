...
CC_SRCS += \
../tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.cc 

CC_DEPS += \
./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.d 

OBJS += \
./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/micro/tools/%.o tensorflow/lite2/micro/tools/%.su tensorflow/lite2/micro/tools/%.cyclo: ../tensorflow/lite2/micro/tools/%.cc tensorflow/lite2/micro/tools/subdir.mk
...
clean: clean-tensorflow-2f-lite2-2f-micro-2f-tools

clean-tensorflow-2f-lite2-2f-micro-2f-tools:
	-$(RM) ./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.cyclo ./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.d ./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.o ./tensorflow/lite2/micro/tools/tflite_flatbuffer_align_wrapper.su

.PHONY: clean-tensorflow-2f-lite2-2f-micro-2f-tools
