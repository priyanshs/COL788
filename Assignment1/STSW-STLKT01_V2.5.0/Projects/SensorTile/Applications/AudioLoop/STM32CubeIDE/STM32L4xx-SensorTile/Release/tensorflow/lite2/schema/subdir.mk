...
CC_SRCS += \
../tensorflow/lite2/schema/schema_utils.cc 

CC_DEPS += \
./tensorflow/lite2/schema/schema_utils.d 

OBJS += \
./tensorflow/lite2/schema/schema_utils.o 


# Each subdirectory must supply rules for building sources it contributes
tensorflow/lite2/schema/%.o tensorflow/lite2/schema/%.su tensorflow/lite2/schema/%.cyclo: ../tensorflow/lite2/schema/%.cc tensorflow/lite2/schema/subdir.mk
...
clean: clean-tensorflow-2f-lite2-2f-schema

clean-tensorflow-2f-lite2-2f-schema:
	-$(RM) ./tensorflow/lite2/schema/schema_utils.cyclo ./tensorflow/lite2/schema/schema_utils.d ./tensorflow/lite2/schema/schema_utils.o ./tensorflow/lite2/schema/schema_utils.su

.PHONY: clean-tensorflow-2f-lite2-2f-schema
