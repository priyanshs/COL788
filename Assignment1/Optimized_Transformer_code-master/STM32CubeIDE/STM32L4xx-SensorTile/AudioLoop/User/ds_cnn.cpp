...
//
//
//const q7_t DS_CNN::conv1_wt[CONV1_OUT_CH*CONV1_KX*CONV1_KY]=CONV1_WT;//not presenst
...
//const q7_t DS_CNN::conv2_pw_wt[CONV2_OUT_CH*CONV1_OUT_CH]=CONV2_PW_WT;//not presenst
...
//const q7_t DS_CNN::conv3_pw_wt[CONV3_OUT_CH*CONV2_OUT_CH]=CONV3_PW_WT;//not presenst
...
//const q7_t DS_CNN::conv4_pw_wt[CONV4_OUT_CH*CONV3_OUT_CH]=CONV4_PW_WT;//not presenst
...
//const q7_t DS_CNN::conv5_pw_wt[CONV5_OUT_CH*CONV4_OUT_CH]=CONV5_PW_WT;//not presenst
...
//  frame_len = FRAME_LEN;//640
//  frame_shift = FRAME_SHIFT;//320
//  num_mfcc_features = NUM_MFCC_COEFFS;//10
//  num_frames = NUM_FRAMES;//49
//  num_out_classes = OUT_DIM;//12
//  in_dec_bits = MFCC_DEC_BITS;//1
//}
//
//DS_CNN::~DS_CNN()
//{
