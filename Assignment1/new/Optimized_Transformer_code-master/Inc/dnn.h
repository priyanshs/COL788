...
#define OUT_DIM 12
/*
#define IP1_OUT_DIM 12 //144
#define IP2_OUT_DIM 12 //144
#define IP3_OUT_DIM 12//144
#define IP1_WT_DIM 12//(IP1_OUT_DIM*IN_DIM)
#define IP2_WT_DIM 12//(IP2_OUT_DIM*IP1_OUT_DIM)
#define IP3_WT_DIM 12//(IP3_OUT_DIM*IP2_OUT_DIM)
#define IP4_WT_DIM 12//(OUT_DIM*IP3_OUT_DIM)
*/
